namespace ShoeStore.Views
{
    partial class frmChiTietNhapKho
    {
        ...
        private void InitializeComponent()
        {
			...
			this.txtGiaGoc = new System.Windows.Forms.NumericUpDown();
			this.groupBox1.SuspendLayout();
			this.groupBoxThongTinBoPhan.SuspendLayout();
			this.groupBoxThongTinChiTiet.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.txtSoLuong)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txtGiaGoc)).BeginInit();
			this.SuspendLayout();
			// 
			// groupBox1
			// 
			...
			// txtSoLuong
			// 
			this.txtSoLuong.Location = new System.Drawing.Point(436, 28);
			...
			this.label5.Location = new System.Drawing.Point(516, 30);
			...
			// txtGiaGoc
			// 
			this.txtGiaGoc.Location = new System.Drawing.Point(566, 27);
			this.txtGiaGoc.Name = "txtGiaGoc";
			this.txtGiaGoc.Size = new System.Drawing.Size(153, 20);
			this.txtGiaGoc.TabIndex = 15;
			this.txtGiaGoc.Maximum = decimal.MaxValue;
			this.txtGiaGoc.Increment = 1000;
			// 
			// frmChiTietNhapKho
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.txtGiaGoc)).EndInit();
		...
		private System.Windows.Forms.NumericUpDown txtGiaGoc;
	}
}