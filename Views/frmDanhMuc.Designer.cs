namespace ShoeStore.Views
{
    partial class frmDanhMuc
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lv.Name = "lv";
			this.lv.Size = new System.Drawing.Size(550, 174);
			this.lv.TabIndex = 0;
			...
			// 
			this.groupBoxThongTinBoPhan.Controls.Add(this.piBImage);
			...
			this.piBImage.Location = new System.Drawing.Point(575, 19);
			this.piBImage.Name = "piBImage";
			this.piBImage.Size = new System.Drawing.Size(229, 174);
			this.piBImage.TabIndex = 1;
			this.piBImage.TabStop = false;
			this.piBImage.DoubleClick += new System.EventHandler(this.piBImage_Click);
			// 
			// btnTimKiemTen
			// 
			...
			this.groupBoxThongTinChiTiet.Controls.Add(this.btnChiTiet);
			...
			// cbHangGiay
			// 
			this.cbHangGiay.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			...
			// btnChiTiet
			// 
			this.btnChiTiet.Location = new System.Drawing.Point(184, 69);
